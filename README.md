...
- [Требуемая структура проекта](#требуемая-структура-проекта)
- [Подключение как Git Submodule](#подключение-как-git-submodule)
- [Использование Tcl-скриптов](#использование-tcl-скриптов)
  - [build_project.tcl](#build_projecttcl)
  - [create_file.tcl](#create_filetcl)
  - [delete_file.tcl](#delete_filetcl)
  - [export_sources.tcl](#export_sourcestcl)
